...
from tendrl.performance_monitoring.objects.definition import performance_monitoring
...
class Definition(objects.BaseObject):
    def __init__(self, *args, **kwargs):
        ...
        self.value = '_tendrl/definitions/performance_monitoring'
        self.performance_monitoring = performance_monitoring.data
        self._parsed_defs = yaml.safe_load(self.performance_monitoring)
...
class _DefinitionEtcd(etcdobj.EtcdObj):
    ...
    """
    __name__ = '_tendrl/definitions/performance_monitoring'
