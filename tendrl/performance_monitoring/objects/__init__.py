...
class PerformanceMonitoringBaseObject(BaseObject):
    def __init__(
            self,
            attrs=None,
            enabled=None,
        ...
        super(PerformanceMonitoringBaseObject, self).__init__(
            attrs=None,
            enabled=None,
            obj_list=None,
            obj_value=None,
        ...
        # ['Node.cmd_str']}, 'run': 'tendrl.performance_monitoring.atoms.node.cmd.Cmd',
        ...
        # 'run': 'tendrl.performance_monitoring.atoms.node.check_node_up',
