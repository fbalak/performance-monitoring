...
- Release tendrl-performance-monitoring v1.4.1

* Sun Jun 04 2017 Rohan Kanade <rkanade@redhat.com> - 1.4.0-3
- Fixes https://github.com/Tendrl/performance-monitoring/pull/180

* Sat Jun 03 2017 Rohan Kanade <rkanade@redhat.com> - 1.4.0-2
- Fixes https://github.com/Tendrl/performance-monitoring/pull/177

* Fri Jun 02 2017 Rohan Kanade <rkanade@redhat.com> - 1.4.0-1
- Release tendrl-performance-monitoring v1.4.0

* Thu May 18 2017 Rohan Kanade <rkanade@redhat.com> - 1.3.0-1
- Release tendrl-performance-monitoring v1.3.0
