...
from tendrl.commons.objects.atoms import BaseAtom


class NodeMonitoringBaseObject(objects.BaseObject):
    def __init__(
            self,
            attrs=None,
            enabled=None,
        ...
        super(NodeMonitoringBaseObject, self).__init__(
            attrs=None,
            enabled=None,
            obj_list=None,
            obj_value=None,
        ...
        # ['Node.cmd_str']}, 'run': 'tendrl.node_monitoring.atoms.node.cmd.Cmd',
...
class NodeMonitoringBaseAtom(BaseAtom):
    obj = NodeMonitoringBaseObject
    def __init__(
            self, *args, **kwargs):
        super(NodeMonitoringBaseAtom, self).__init__(*args, **kwargs)
